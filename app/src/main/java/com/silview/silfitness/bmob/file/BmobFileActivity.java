package com.silview.silfitness.bmob.file;
...
public class BmobFileActivity extends BaseActivity implements OnClickListener, FileChooserListener {
	...
	public void initViews() {
		tv_one_one = findViewById(R.id.tv_one_one);
		tv_one_many = findViewById(R.id.tv_one_many);
		tv_many_one = findViewById(R.id.tv_many_one);
		tv_many_many = findViewById(R.id.tv_many_many);
		btn_delete = findViewById(R.id.btn_delete);
		btn_delete_batch = findViewById(R.id.btn_delete_batch);
